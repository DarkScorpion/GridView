...
public class GridViewActivity extends Activity 
{
	...
	final static int COL_NUMBER = 5; //количество стобцов, нужно равное аргументы в layout
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		gvMain.setAdapter( new ImageAdapter(this, RandomFilling()) );
	...
	public int[] RandomFilling()
	{
		...
		for(int i=0;i<A.length;i++)
			A[i] = imageId[rndNum.nextInt(imageId.length)];
		return A;
	}
